...
## [Unreleased]
### Added
- [#160](https://github.com/equinor/flownet/pull/160) Adds the possibility to extract regions from an existing model when the data source is a simulation model. For relative_permeability and equil, the scheme key can be set to 'regions_from_sim'
